...
const TierTable = () => {
  ...
  // S:  120 죽나상, 13 후파우, 98 넬슈, 123 섕르소, 132 탕루, 85 디루, 131 탕히스,
  //     122 츠이스, 121 제로쟈, 61 디로쟈, 72 쥐싱, 129 제싱클, 75 섕싱,  103 런싱

  const A = [120, 13, 98, 123, 85, 122, 121, 61, 72, 129, 75, 103];

  // A: 137 리상, 10 쥐파,3 떱돈, 66 떱슈,32 k루,30 콩루, 27 퀴히스, 135 흑히스, 102 선장마엘, 136 흑이스, 125 혈티스, 83 마티스, 94 치티스
  const B = [137, 10, 3, 66, 32, 30, 27, 135, 102, 136, 125, 83, 94];

  // B: 81 떱상, 12 세파우, 114 디뫼, 23 r히스, 91 리쟈, 115 떱티스, 127 혈그렉, 96 퐁그렉, 20 갈그렉
  const C = [81, 12, 114, 23, 91, 115, 127, 96, 20];

  // C: 79 동상, 112 티돈, 134 홍파우, 40 리우마엘, 93 외히스
  const D = [79, 112, 134, 91, 40, 93];

...
const TierTable = () => {
  ...
  // S+: 130 실돈키, 100 약상, 128 돌로쟈,  118 마히스
  const S = [130, 100, 128, 118];

  // S:  122 츠이스, 102 선장마엘, 72 쥐싱, 61 디로쟈,98 넬슈, 27 퀴히스, 75 섕싱, 121 제로쟈, 123 섕르소, 제싱클, 85 디루, 127 혈그렉, 94 치티스
  const A = [122, 102, 72, 61, 98, 27, 75, 121, 123, 129, 85, 127, 94];

  // A: 125 혈티스, 3 떱돈, 66 떱슈, 23 r히스, 114 디뫼, 96 퐁그렉, 20 갈그렉, 32 k루, 30 콩루
  const B = [125, 3, 66, 23, 114, 96, 20, 32, 30];

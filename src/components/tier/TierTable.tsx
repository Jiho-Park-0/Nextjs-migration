...
const TierTable = () => {
  ...
  // S+: 100 약상, 130 실돈키, 119 적슈, 118 마히스, 128 돌로쟈
  const S = [100, 119, 130, 118, 128];

  // S:  146 흑쟈, 145 흑그렉, 139 동섕돈, 120 죽나상, 13 후파우, 98 넬슈, 123 섕르소, 132 탕루, 85 디루, 131 탕히스,
  //     122 츠이스, 121 제로쟈, 61 디로쟈, 72 쥐싱, 129 제싱클, 75 섕싱,  103 런싱, 138 불그렉

  const A = [
    146, 145, 139, 120, 13, 98, 123, 85, 122, 121, 61, 72, 129, 75, 103, 138,
  ];

  // A: 143 R루, 137 리상, 141 묘슈, 3 떱돈, 66 떱슈,30 콩루, 27 퀴히스, 135 흑히스, 102 선장마엘, 136 흑이스, 91 리쟈,125 혈티스, 83 마티스, 94 치티스, 142 중싱
  const B = [143, 137, 141, 3, 66, 30, 27, 135, 102, 136, 91, 125, 83, 94, 142];

  // B: 81 떱상,10 쥐파, 12 세파우,134 홍파우, 114 디뫼, 32 k루,23 r히스,  115 떱티스, 127 혈그렉, 96 퐁그렉, 20 갈그렉
  const C = [81, 10, 12, 114, 134, 32, 23, 115, 127, 96, 20];

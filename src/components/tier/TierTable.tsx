...
const TierTable = () => {
  ...
  // S:  120 죽나상, 13 후파우, 122 츠이스, 72 쥐싱, 61 디로쟈,98 넬슈, 85 디루, 132 탕히스,  27 퀴히스, 131 탕히스 75 섕싱, 121 제로쟈, 123 섕르소, 129 제싱클, 103 런싱
  const A = [
    120, 13, 122, 72, 61, 98, 85, 132, 27, 131, 75, 121, 123, 129, 103,
  ];

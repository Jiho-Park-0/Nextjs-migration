...
const TierTable = () => {
  ...
  // S:  139 동섕돈, 120 죽나상, 13 후파우, 98 넬슈, 123 섕르소, 132 탕루, 85 디루, 131 탕히스,
  //     122 츠이스, 121 제로쟈, 61 디로쟈, 72 쥐싱, 129 제싱클, 75 섕싱,  103 런싱, 138 불그렉

  const A = [139, 120, 13, 98, 123, 85, 122, 121, 61, 72, 129, 75, 103, 138];

  // A: 137 리상, 3 떱돈, 66 떱슈,30 콩루, 27 퀴히스, 135 흑히스, 102 선장마엘, 136 흑이스, 91 리쟈,125 혈티스, 83 마티스, 94 치티스
  const B = [137, 3, 66, 30, 27, 135, 102, 136, 91, 125, 83, 94];

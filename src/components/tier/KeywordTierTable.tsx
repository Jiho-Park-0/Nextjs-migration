...
const KeywordTierTable = () => {
  ...
  // 파열: 145 흑쟈, 144 흑그렉,141 묘슈, 140 묘티스, 121 제로쟈, 12 세파우, 123 섕르소, 129 제싱클, 133 초상, 32 k루, 126 송루, 44 떱르소, 84 초돈, 26 셉히스, 52 셉티스, 95 데뫼, 18 장그렉
  const C = [
    146, 145, 141, 140, 121, 12, 123, 129, 133, 32, 126, 44, 84, 26, 52, 95, 18,
  ];

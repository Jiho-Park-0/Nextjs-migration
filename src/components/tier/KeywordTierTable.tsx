...
const KeywordTierTable = () => {
  ...
  // 출혈: 136 흑이스, 135 흑히스, 130 실돈키, 100 약상, 119 적슈, 128 돌로쟈, 102 선장마엘, 27 퀴히스, 127 혈그렉, 125 혈티스, 10 쥐파, 20 갈그렉, 6 중돈, 65 료슈, 72 쥐싱,
  //      64 흑슈, 34 갈루, 101 약티스, 30 콩루, 57 흑로쟈, 29 흑루, 82 피상, 90 흑그렉, 48 중뫼
  const S = [
    136, 135, 130, 100, 119, 128, 102, 27, 127, 125, 10, 20, 6, 65, 72, 64, 34,
    101, 30, 57, 29, 82, 90, 48,
  ];
  ...
  // 파열: 141 묘슈, 140 묘티스, 121 제로쟈, 12 세파우, 123 섕르소, 129 제싱클, 133 초상, 32 k루, 126 송루, 44 떱르소, 84 초돈, 26 셉히스, 52 셉티스, 95 데뫼, 18 장그렉
  const C = [141, 140, 121, 12, 123, 129, 133, 32, 126, 44, 84, 26, 52, 95, 18];
